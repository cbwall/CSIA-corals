...
for(i in c(11:23)){
  ...
  print(anova(mod))
  plot(allEffects(mod), ylab=colnames(d13C.dat2)[i])
}
...
##################
#########
# weighted means for trophic and source AA
# following Bradley et al. 2015
...
##################
#########
# calculate Sum-V, McCarthy et al. 2007
# sum-V parameter (proxy for total heterotrophic resynthesis) is defined as the average deviation in the d15N values of the Tr-AA Ala, Asp, Glu, Ile, Leu, and Pro.
