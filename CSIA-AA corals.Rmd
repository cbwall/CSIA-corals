...
#### d13C
mod1<-(lm(d13C~Location+Season+SW.fraction..um, data=SWiso)); Anova(mod, type=2) # no location or season effect

posthoc<-emmeans(mod1, ~SW.fraction..um)
multcomp::cld(posthoc, Letters=letters) # only diff for the 10-100 um fraction

#### d15N
mod2<-(lm(d15N~Location+Season+SW.fraction..um, data=SWiso)); Anova(mod, type=2) # mild season effect
